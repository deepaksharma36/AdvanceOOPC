...
/* this class sends data with tcp or udp protocol.
...
public class tpClient {
	...
	//this method sends data with tcp protocol to the server.
	...
	//this  method sends data with udp protocol to the server.
